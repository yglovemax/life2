...
class Settings(BaseModel):
    ...
    bazi_calc_mode: str = Field(default_factory=lambda: os.environ.get("NEXA_BAZI_CALC_MODE", "mock"))
    bazi_api_url: str = Field(default_factory=lambda: os.environ.get("NEXA_BAZI_API_URL", ""))
    bazi_api_token: str = Field(default_factory=lambda: os.environ.get("NEXA_BAZI_API_TOKEN", ""))
    bazi_request_timeout_seconds: int = Field(default_factory=lambda: env_int("NEXA_BAZI_REQUEST_TIMEOUT_SECONDS", 30))
